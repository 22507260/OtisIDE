...
const UI_STRINGS = {
  en: {
    ...
    simulationLockedHint: 'The circuit is locked while the simulation runs.',
    board: 'Board',
    ...
    on: 'ON',
    off: 'OFF',
    buttonPressed: 'Held down',
    buttonReleased: 'Released — press it on the canvas',
    live: 'Live',
    resetZoom: 'Zoom 100%',
    ...
    circuitErrorUnknownMember:
      "'{{object}}' has no member named '{{name}}' (line {{line}}).",
    circuitErrorUnknownMemberSuggestion:
      "'{{object}}' has no member named '{{name}}' (line {{line}}). Did you mean '{{suggestion}}'?",
    ...
    errorDialogHint: 'Closing this keeps every problem in the Errors tab at the bottom.',
    errorDialogShowAll: 'Open the Errors tab',
    errorDialogClose: 'Close',
    unsavedTitle: 'Save your changes?',
    unsavedBody: '{{name}} has changes that are not saved yet. Save them before carrying on?',
    unsavedSave: 'Save',
    unsavedDiscard: "Don't save",
    unsavedCancel: 'Cancel',
    unsavedProjectName: 'This project',
    errorsTab: 'Errors',
    errorsEmpty: 'No problems so far.',
  ...
  tr: {
    ...
    simulationLockedHint: 'Simülasyon çalışırken devre değiştirilemez.',
    board: 'Kart',
    ...
    on: 'AÇIK',
    off: 'KAPALI',
    buttonPressed: 'Basılı',
    buttonReleased: 'Bırakılmış — tuvalde üstüne basılı tut',
    live: 'Canlı',
    ...
    circuitErrorUnknownMember:
      "'{{object}}' nesnesinin '{{name}}' diye bir üyesi yok (satır {{line}}).",
    circuitErrorUnknownMemberSuggestion:
      "'{{object}}' nesnesinin '{{name}}' diye bir üyesi yok (satır {{line}}). '{{suggestion}}' mı demek istedin?",
    ...
    errorDialogHint: 'Bunu kapatsan da tüm sorunlar alttaki Hatalar sekmesinde durmaya devam eder.',
    errorDialogShowAll: 'Hatalar sekmesini aç',
    errorDialogClose: 'Kapat',
    unsavedTitle: 'Değişiklikler kaydedilsin mi?',
    unsavedBody: '{{name}} içinde kaydedilmemiş değişiklikler var. Devam etmeden önce kaydedilsin mi?',
    unsavedSave: 'Kaydet',
    unsavedDiscard: 'Kaydetme',
    unsavedCancel: 'Vazgeç',
    unsavedProjectName: 'Bu proje',
    errorsTab: 'Hatalar',
    errorsEmpty: 'Şimdiye kadar bir sorun yok.',
    errorsClear: 'Listeyi temizle',
    driverForward: 'İLERİ',
    driverReverse: 'GERİ',
    driverBrake: 'FREN',
    driverCoast: 'SERBEST',
