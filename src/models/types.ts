...
export const COMPONENT_CATALOG: ComponentInfo[] = [
  ...
  { type: 'breadboard-mini', name: 'Mini Breadboard', category: 'Board', icon: 'BB-' },
  // Passive
  ...
  // Battery
  { type: 'li-ion-battery', name: 'Li-ion Battery', category: 'Battery', icon: 'LI' },
  { type: 'li-po-battery', name: 'Li-Po Battery', category: 'Battery', icon: 'LIPO' },
  { type: '9v-battery', name: '9V Battery', category: 'Battery', icon: '9V' },
  { type: 'aa-battery', name: 'AA Battery (1.5V)', category: 'Battery', icon: 'AA' },
  { type: 'coin-cell-3v', name: 'Coin Cell (3V)', category: 'Battery', icon: 'CR' },
  // Other
