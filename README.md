...
This runs the Electron build and then copies the installer into `website/downloads/`,
refreshing the version and file size shown on `website/index.html`. Upload the whole
`website/` folder to any static host (Netlify, Vercel, GitHub Pages) to publish the
download page.
